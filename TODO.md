...
- при пакетном добавлении результато и их сохранении - помечать, что они введены имортом - к 
...
- проверка затупителей (кол-во затруднивш превышает процент в конфиг файле, если в конфиге отсутствует - выставить по умолчанию) - о
